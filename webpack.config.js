...
const wPackConfig = {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin({
          patterns: [
            // Copy the contact.php file from app/ to dist/
            { from: path.resolve(__dirname, 'app/contact.php'), to: path.resolve(__dirname, 'dist') },
            // Optionally, add other files you want to copy over
          ],
        }),
